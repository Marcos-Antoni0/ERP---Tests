...
urlpatterns = [
    ...
    path("caixa/movimentacao/", views.register_cash_movement, name="register_cash_movement"),
    path("caixa/fechar/", views.close_cash_session, name="close_cash_session"),
    path("caixa/relatorio/<int:session_id>/", views.cashier_session_report, name="cashier_session_report"),
    ...
    path("sales/<int:sale_id>/reabrir-comanda/", reabrir_venda_mesa, name="reabrir_venda_mesa"),
